...
--
-- Host: localhost:3306
-- Generation Time: Oct 07, 2017 at 05:47 AM
...
(3, '21277683_1978258452449617_692754971_o.png');
...
INSERT INTO `reply` (`ReplyID`, `QuestionID`, `CreateDate`, `Details`, `Name`, `empn`) VALUES
(00005, 00003, '2017-10-06 01:02:32', 'ได้ดิ', 'Khunponpun Thongaroon', NULL),
(00006, 00003, '2017-10-06 01:02:47', 'ลองดู', 'Khunponpun Thongaroon', NULL),
(00007, 00003, '2017-10-06 01:03:51', 'ลองดู', 'Khunponpun Thongaroon', NULL),
(00008, 00003, '2017-10-06 01:07:16', 'test', 'Khunponpun Thongaroon', '593403'),
(00009, 00003, '2017-10-06 01:08:55', 'test', 'Khunponpun Thongaroon', '593403'),
(00010, 00003, '2017-10-06 01:09:19', 'test', 'Khunponpun Thongaroon', '593403'),
(00011, 00004, '2017-10-06 01:12:40', 'aaaa', 'Khunponpun Thongaroon', '593403'),
(00012, 00005, '2017-10-06 15:18:37', 'มาสิ', 'Khunponpun Thongaroon', '593403');
...
INSERT INTO `tbl_comments` (`cm_id`, `post_id`, `txt_comments`, `empn`, `record_date`) VALUES
(1, 6, 'test', '593403', NULL),
(2, 6, 'test2', '593403', '2017-10-06 14:03:24'),
(3, 8, 'test', '593403', '2017-10-06 14:06:08'),
(4, 8, 'rrrrrr', '593403', '2017-10-06 14:06:23'),
(5, 9, 'ดีมากครับ', '593403', '2017-10-06 14:07:11'),
(6, 11, 'new', '593403', '2017-10-06 14:11:39');
...
INSERT INTO `tbl_users` (`empn`, `fullname`, `user_tel`, `user_password`, `user_pic`, `user_dept`, `record_date`, `update_date`, `fb_name`, `fb_pro_img`) VALUES
('593403', 'ขุนพลพัน ทองอรุณ', '4839', '018762697', '2.jpg', 'ชชม.', '2017-10-04 22:22:01', NULL, 'Khunponpun Thongaroon', 'https://scontent.xx.fbcdn.net/v/t1.0-1/p200x200/21231241_1850217551661089_9020487366037003887_n.jpg?oh=a3002c941ff97fd334637fecb7534c3a&oe=5A84ADD3');
...
INSERT INTO `webboard` (`QuestionID`, `CreateDate`, `Question`, `Details`, `Name`, `View`, `Reply`, `empn`) VALUES
(00003, '2017-10-06 00:30:47', 'เริ่มใหม่', 'ได้ไหม', 'Khunponpun Thongaroon', 65, 6, '593403'),
(00004, '2017-10-06 01:12:30', 'NEw', 'NEW', 'Khunponpun Thongaroon', 2, 1, '593403'),
(00005, '2017-10-06 15:18:23', 'New2', 'New2', 'Khunponpun Thongaroon', 3, 1, '593403');
...
--
ALTER TABLE `reply`
  MODIFY `ReplyID` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `webboard`
  MODIFY `QuestionID` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;COMMIT;
