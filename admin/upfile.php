...
<body>
    ...
    <script>
        $('#fine-uploader-manual-trigger').fineUploader({
            ...
            request: {
                endpoint: '/new/upload.php'
            },
            thumbnails: {
                placeholders: {
                    waitingPath: '/new/lib/fine-uploader/placeholders/waiting-generic.png',
                    notAvailablePath: '/new/lib/fine-uploader/placeholders/not_available-generic.png'
                }
            },
            autoUpload: false,
            callbacks: {
